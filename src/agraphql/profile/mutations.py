...
class CreateProfile(graphene.Mutation):
    ...
    def mutate(cls, root, info, **kwargs):
        try:
            ...
            create_kwargs = {}
            for field in models.Profile._meta.fields:  # Using fields only
            ...
            create_kwargs["added_by"] = models.Profile.objects.get(pk=kwargs['added_by'])
            instance = models.Profile.objects.create(**create_kwargs)
            ...
            return CreateProfile(success=False, message=e.message)
...
class UpdateProfile(graphene.Mutation):
    ...
    def mutate(cls, root, info, id, **kwargs):
        try:
            # Get instance
            instance = models.Profile.objects.get(pk=id)
            ...
            instance.updated_by = models.Profile.objects.get(pk=kwargs['updated_by'])
            instance.full_clean()
            instance.save()
            ...
            return UpdateProfile(success=False, message=e.message)
        except Exception as e:
            return UpdateProfile(
                success=False, 
