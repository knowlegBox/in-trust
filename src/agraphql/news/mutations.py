...
class CreateNews(graphene.Mutation):
    ...
    def mutate(cls, root, info, **kwargs):
        try:
            ...
            create_kwargs = {}
            for field in models.News._meta.fields:  # Using fields only
            ...
            create_kwargs["added_by"] = models.News.objects.get(pk=kwargs['added_by'])
            instance = models.News.objects.create(**create_kwargs)
            return CreateNews(
                success=True,
            ...
            return CreateNews(success=False, message=e.message)
...
class UpdateNews(graphene.Mutation):
    ...
    def mutate(cls, root, info, id, **kwargs):
        try:
            # Get instance
            instance = models.News.objects.get(pk=id)
            ...
            instance.updated_by = models.News.objects.get(pk=kwargs['updated_by'])
            instance.full_clean()
            instance.save()
            return UpdateNews(
                success=True,
            ...
            return UpdateNews(success=False, message=e.message)
        except Exception as e:
            return UpdateNews(
                success=False, 
